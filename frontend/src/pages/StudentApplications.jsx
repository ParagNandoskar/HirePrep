                ...
                <div className="flex items-center gap-3 ml-4">
                  ...
                  {(application.status === 'pending' || application.status === 'applied') && !application.interviewCompleted && (
                    <button
                      ...
                      className="flex items-center space-x-2 px-4 py-2 bg-linear-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-sm"
                    >
